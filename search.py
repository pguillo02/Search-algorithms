...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Nº nodos visitados = ", visitados)
            print("Nº nodos expandidos = ", fringe.expanded)
            return node
...
def branch_and_bound(problem):
    """Search the shortest possible path"""
    return graph_search(problem, PriorityQueue())

def branch_and_bound_sub(problem):
    """Search the shortest possible path based on heuristics"""
    return graph_search(problem, PriorityQueueBabs(problem))
